  ...
  <div class="category-section">
    <div class="category-container">
      ...
      <div class="products-grid">
        <div
          v-for="doanhNghiepProducts in doanhNghiepProducts"
          :key="doanhNghiepProducts.id"
          class="product-item"
          @click="goToProduct(doanhNghiepProducts.id)"
        >
          <!-- Product Image -->
          ...
          <div class="product-name-box">
            <h3 class="product-title">{{ doanhNghiepProducts.name }}</h3>
          </div>
        </div>
      </div>
    </div>
