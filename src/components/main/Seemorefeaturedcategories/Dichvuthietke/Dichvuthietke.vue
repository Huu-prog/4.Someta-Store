    ...
    <div class="page-container">
      ...
      <aside class="sidebar">
        ...
        <div class="filter-section">
            <h3 class="filter-title"   @click="toggleSection">Sản phẩm nổi bật
           <svg class="arrow-icon" :class="{ rotate: isOpen }" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div class="filter-section">
            <h3 class="filter-title"   @click="toggleDesgin">Dịch vụ thiết kế 
           <svg class="arrow-icon" :class="{ rotate: isOpens }" viewBox="0 0 24 24" fill="currentColor">
              <path d="M10 15l5 5 5-5z"/>
            </svg>
          </h3>
      ...
      <!-- Products Grid -->
       <h1 style="color: orange;">Tất cả sản phẩm! Quà tặng: {{ categorizeId }}</h1>
        ...
        <div class="why-choose-section">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Cam kết 100% hàng chính hãng, nguồn gốc rõ ràng, được kiểm tra kỹ lưỡng trước khi giao hàng</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-truck"></i></div>
                    <h3>Giao Hàng Nhanh</h3>
                    <p>Giao hàng toàn quốc, nhanh chóng trong 2-3 ngày. Miễn phí vận chuyển cho đơn hàng trên 500k</p>
                </div>
                <div class="feature-card">
            ...
            <div class="reviews-grid">
                <div class="review-card">
                    ...
                    <p class="review-text">
                        ...
                        giao hàng nhanh. Nhân viên tư vấn nhiệt tình. Rất hài lòng và sẽ tiếp tục ủng hộ!"
                    </p>
                    <div class="reviewer">
                ...
                <div class="review-card">
                    <div class="stars">⭐⭐⭐⭐⭐</div>
                    <p class="review-text">
                        "Đã đặt 100 bộ quà tặng cho nhân viên. Chất lượng tuyệt vời, 
                        giá cả hợp lý. In logo rất đẹp và chuyên nghiệp. Highly recommended!"
                    </p>
                    <div class="reviewer">
                ...
                <div class="review-card">
                    <div class="stars">⭐⭐⭐⭐⭐</div>
                    <p class="review-text">
                        "Quà tặng đẹp, ý nghĩa. Nhân viên rất thích. 
                        Dịch vụ chăm sóc khách hàng tốt. Cảm ơn shop rất nhiều!"
                    </p>
                    <div class="reviewer">
        ...
        <div class="faq-section">
            ...
            <div class="faq-list">
                <div class="faq-item">
                    ...
                    <p>
                        Quý khách vui lòng liên hệ hotline 1900-xxxx hoặc email sales@sometagift.com 
                        để được tư vấn chi tiết và báo giá ưu đãi cho đơn hàng số lượng lớn. 
                        Chúng tôi có chính sách giảm giá đặc biệt cho đơn hàng từ 50 sản phẩm trở lên.
                    </p>
                </div>
                <div class="faq-item">
                    <h3>❓ Có được in logo công ty lên sản phẩm không?</h3>
                    <p>
                        Có, chúng tôi cung cấp dịch vụ in logo, khắc tên MIỄN PHÍ cho đơn hàng từ 20 sản phẩm trở lên. 
                        Thời gian in ấn từ 3-5 ngày làm việc. Quý khách cần cung cấp file logo vector (AI, PDF) để đảm bảo chất lượng in tốt nhất.
                    </p>
                </div>
                <div class="faq-item">
                    <h3>❓ Thời gian giao hàng là bao lâu?</h3>
                    <p>
                        Đơn hàng trong nội thành Hà Nội và TP.HCM sẽ được giao trong 24h. 
                        Đơn hàng tỉnh xa từ 2-3 ngày làm việc. Đối với đơn hàng có in ấn logo, 
                        thời gian giao hàng sẽ tăng thêm 3-5 ngày.
                    </p>
                </div>
                <div class="faq-item">
                    <h3>❓ Chính sách đổi trả như thế nào?</h3>
                    <p>
                        Chúng tôi hỗ trợ đổi trả trong vòng 7 ngày kể từ ngày nhận hàng nếu sản phẩm có lỗi từ nhà sản xuất, 
                        bị vỡ trong quá trình vận chuyển hoặc không đúng mô tả. 
                        Sản phẩm đổi trả phải còn nguyên vẹn, chưa qua sử dụng và còn đầy đủ hộp, nhãn mác.
                    </p>
                </div>
                <div class="faq-item">
                    <h3>❓ Có hỗ trợ thanh toán trả góp không?</h3>
                    <p>
                        Có, chúng tôi hỗ trợ thanh toán trả góp 0% qua các đối tác: 
                        Home PayLater, Fundiin, MoMo, ZaloPay cho đơn hàng từ 3 triệu đồng trở lên.
                    </p>
                </div>
            </div>
        </div>
