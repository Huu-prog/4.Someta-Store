      ...
      <div class="footer-container">
        ...
        <div class="footer-column">
          ...
          <p class="footer-description">
            Chuyên cung cấp quà tặng doanh nghiệp cao cấp, dịch vụ in ấn và thiết kế chuyên nghiệp.
            Cam kết chất lượng và uy tín hàng đầu.
          </p>
          <div class="social-links">
            <a
              href="https://www.facebook.com/profile.php?id=61557923229415"
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path
                  d="M12 0C5.373 0 0 4.97 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.301 2.246.464 3.443.464 6.627 0 12-4.97 12-11.111C24 4.97 18.627 0 12 0zm.696 14.947l-3.055-3.255-5.963 3.255L10.304 8l3.127 3.255L19.359 8l-6.663 6.947z"
                />
              </svg>
            </a>
          </div>
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            ...
            <li>
              <router-link to="/Xemthemsanphamnoibat" @click="closeMenu">Quà tặng</router-link>
            </li>
        ...
        <div class="footer-column">
          ...
          <ul class="footer-contact">
            <li>
              ...
              <span>Trụ sở chính: Chợ Xoài Xiêm, Ngãi Xuyên, Trà Cú, Trà Vinh</span>
              <span>Chi nhánh 2: Thanh Sơn, Trà Cú, Trà Vinh (gần công ty Mỹ Phong Trà Cú)</span>
            </li>
            <li>
              <svg
                width="18"
    ...
    <div class="footer-bottom">
      <div class="footer-container">
        <div class="footer-bottom-content">
          <p class="copyright">&copy; {{ currentYear }} Someta Store. All rights reserved.</p>
          <div class="footer-bottom-links">
            <router-link to="/Privacy_Policy">Chính sách bảo mật</router-link>
            <span>|</span>
            <router-link to="/Terms_of_Use">Điều khoản sử dụng</router-link>
            <span>|</span>
            <router-link to="/returnpolicy">Chính sách đổi trả</router-link>
          </div>
        </div>
      </div>
    </div>
